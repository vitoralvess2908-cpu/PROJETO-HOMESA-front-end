...
let html = "";
    ...
    <div class="cadastrar">
            <h3>Cadastre já um imóvel,é rápido e fácil🏠</h3>
            <p>Apenas click no link abaixo </p>
            <a href="indexImovel.html">Cadastrar um imóvel</a>
        </div><br>
    ...
    <div class="cliente">
        ...
        <p><strong>Tipo de conta:</strong> PROPRIETÁRIO</p>
        </div>
